...
<body style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; border: 1px solid #ddd; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.05);">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tbody>
                <!-- Example line item, you can replicate this for each item in the order -->
                <tr>
                    <td style="padding: 10px 0; border-bottom: 1px solid #ddd;">XtremeDrive TrailBlazer</td>
                    <td style="padding: 10px 0; border-bottom: 1px solid #ddd; text-align: center;">99</td>
                    <td style="padding: 10px 0; border-bottom: 1px solid #ddd; text-align: right;">€19.99</td>
                </tr>
                <!-- End of example line item -->
            </tbody>
        </table>
        
        <p style="text-align: right; margin-top: 20px; font-weight: bold;">Total: <span style="color: #007BFF;">$99.99</span></p>
